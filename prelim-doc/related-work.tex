...
of value changes for variables. If a variable \m{x1} in the original program
have the same values as a variable \m{x2} in the optimized version at some
...
correspondence. We note that only the basic blocks \m{b1} and \m{b2}, which are
