...
and/or output program.\Comment{Brief the concept}
%
...
language semantics. The algorithm employs the notion of cut-bisimulation,
         ...
         points. \cmt{Intuitively, synchronization points are symbolic
           descriptions that capture the set of pairs of relevant (concrete)
             states of the input and output programs.}
