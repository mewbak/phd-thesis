...
because, in many circumstances, it is the only way to prove (or disprove)
  ...
  compilers~\cite{Thompson,WYSINWYE}\todo{references are sorted alphabetically}.
...
\todo[inline]{Formally establishing faithfulness of the decompilation (i.e. translation from
...
\todo{sentence rephrased}Given the recent advances in translation validation in validating compilation,
